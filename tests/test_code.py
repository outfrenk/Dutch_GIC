...
def test_download(tmpdir):
    ...
    os.system(f'rm -r {tmpdir}/12-03-1997')
    os.system(f'rm -r {tmpdir}/10-03-1997')
    ...
    os.system(f'rm -r {tmpdir}/31-12-2009')
    os.system(f'rm -r {tmpdir}/07-01-2010')
    ...
    os.system(f'rm -r {tmpdir}/01-01-200')
    os.system(f'rm -r {tmpdir}/22-12-1999')